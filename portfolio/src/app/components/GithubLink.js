...
export default function GithubIcon() {
    ...
    return (
        ...
        onClick={() => window.open('https://github.com/an-siuu-man', '_blank')}>
            ...
            <div>
                ...
                >
                    <g id="Icons" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                        <g id="Color-" transform="translate(-700.000000, -560.000000)" fill={isHovered ? "#111" : "#a5a5a5"}>
                            <path
            ...
            <p className={`font-dmsans font-light text-lg ${isHovered ? 'opacity-1' : 'opacity-0'} duration-300`}>GitHub</p>
        </div>
    );
}