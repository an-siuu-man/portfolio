...
export default function InstagramLink() {
    ...
    return (
        <div 
        className={`duration-300 ease-in-out cursor-pointer overflow-hidden cursor-pointer ${isHovered ? 'max-h-[80px]' : 'max-h-[50px]'} flex flex-col items-center`}
        onClick={() => window.open('https://www.instagram.com/an_siuu_man', '_blank')}>
            ...
            <div>
                ...
                >
                    <circle cx="512" cy="512" r="512" fill={isHovered ? "#e4405f" : "#a5a5a5"}
                    className='transition duration-300' />
                    <path 
            ...
            <p className={`font-dmsans font-light text-lg ${isHovered ? 'opacity-1' : 'opacity-0'} duration-300`}>Instagram</p>
        </div>
    );
}