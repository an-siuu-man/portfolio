...
export default function LinkedinIcon() {
    ...
    return (
        <div 
        className={`duration-300 ease-in-out cursor-pointer overflow-hidden ${isHovered ? 'max-h-[80px]' : 'max-h-[60px]'} flex flex-col items-center`}
        onClick={() => window.open('https://www.linkedin.com/in/ansuman-sharma')}>
